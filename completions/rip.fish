# Fish completions for rip - https://github.com/MilesCranmer/rip2
# Autogenerated completions from https://github.com/clap-rs/clap include -f on
# the subcommands which means the completion may not be followed by a filename,
# making usage problematic. These completions fix that until the issue is
# resolved upstream.
